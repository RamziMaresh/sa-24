...
const page = () => {
    return (
        <SafraLayout>
            <PageBanner pageName={"PVC/CPVC Cement"} />
                    ...
                    <div className="row">
                        <div className="col-xl-9 col-lg-11 pt-60 pb-0">
                            <div className="tag-share pt-0 pb-0">
                                <h4>Chemplex (PVC/CPVC Cement) </h4>
                            </div>
                            <div className="pb-20">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        >
                                            <div className="image">
                                                <img src="assets/images/projects/project-grid99.svg" alt="Product-8" width={300} />
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <h6>
                                            <div >Safra Bond (PVC Cement Gray)</div>
                                        </h6>
                                        <ul className="icon-list-chemplex mt-20 mb-35">
